...
import MAinImage from "../../../public/assets/camels.jpeg";
// Define the types
interface Tour {
  id: number;
  title: string;
...
const RecentBlog = () => {
  ...
  const currentTours = staticToursData.slice(indexOfFirstTour, indexOfLastTour);
  const pageCount = Math.ceil(staticToursData.length / toursPerPage);
