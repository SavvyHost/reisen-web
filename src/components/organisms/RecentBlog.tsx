      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 mt-3">
        {currentBlogs.map((post) => (
          <Link href={`/blogs/${post.id}`} key={post.id}>
            <div className="w-full hover:border-blue-500 bg-white rounded-xl border-gray-300 border overflow-hidden transition-shadow duration-300 hover:shadow-xl cursor-pointer">
              ...
              <div className="flex flex-row md:hidden">
                <div className="w-1/3 h-32 sm:h-40 relative">
                  ...
                  />
                  <div className="absolute top-2 left-2 bg-blue-500 text-white px-2 py-1 text-xs font-segoe rounded-sm shadow-md">
                    Featured
                  </div>
