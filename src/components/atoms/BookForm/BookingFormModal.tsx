...
export default function BookingFormModal({ DetailTour }) {
  ...
  return (
    <>
      <Button
        className="py-2 capitalize w-full bg-red-700 text-white rounded-none hover:bg-yellow-500 transition duration-300 font-segoe fixed top-[58px] right-0 z-40 md:hidden"
